...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "Folo";
    rev = "v${version}";
    hash = "sha256-51/cAbpgMsOLEynRwCrcO4r0vhZNyOSQfwz8wV8ux0I=";
  };
  ...
  pnpmDeps = pnpm_10.fetchDeps {
    ...
    hash = "sha256-jNSju3/Vxt+YaNH5t2Dhay27DyMauOr3RPI07dqqSUA=";
  };
  ...
  meta = {
    ...
    changelog = "https://github.com/RSSNext/Folo/releases/tag/v${version}";
